...
//   ...canonicalMeta('/offline-puja-services'),
...
//     {
//         id: '15',
//         name: 'Sunderkand Path (Mool Path)',
//         price: 2100,
//         originalPrice: 2501,
//         duration: '2-3 Hrs',
//         views: 2200,
...
//         duration: '1-2 Hrs',
//         views: 3000,
//         image: { url: '/images/poojaas/pitru-paksha-shraddha-puja.png' }
//     },
//     {
//         id: '52',
...
// Master Service catalog (Admin -> Master Services) is now the single
// source of truth for this listing - was previously a hardcoded array.
// Only ACTIVE master services are returned by this API.
async function getAllServices() {
    try {
        const res = await fetch(
            `${baseUrl}/api/getHomepagePoojaServicesAll?page=1&limit=100`,
            { next: { revalidate: 60 } }
        );
