...
export function TestimonialCard({ item, variant = 'carousel' }) {
  const fullName =
  ...
  return (
    <Card
      sx={{
        position: 'relative',
        flex: isGrid ? '1 1 auto' : '0 0 auto',
        width: isGrid ? '100%' : { xs: 270, sm: 320 },
...
TestimonialCard.propTypes = { item: PropTypes.object.isRequired, variant: PropTypes.oneOf(['carousel', 'grid']) };
